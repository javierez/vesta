...
export function generateStaticParams() {
  return [{ type: "prospects" }, { type: "leads" }, { type: "deals" }];
}
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700">
                <p>
                  ...
                  {typeNames[operationType]}. Por favor, intenta actualizar la
                  página.
                </p>
...
async function OperationsData({
  ...
  try {
    ...
    const { getKanbanDataWithAuth } = await import(
      "~/server/queries/operations-kanban"
    );
    ...
    const { getOperationCountsWithAuth } = await import(
      "~/server/queries/operations-kanban"
    );
    ...
    return (
      <OperationsError operationType={operationType} error={error as Error} />
    );
  }
}
