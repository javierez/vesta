        ...
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Esta cita ya tiene una visita registrada. No se puede crear otra
                visita para la misma cita.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="rounded bg-gray-50 p-3 text-sm text-gray-600">
                  <p>
                    ...
                    {result.appointment.contactFirstName}{" "}
                    {result.appointment.contactLastName}
                  </p>
                  <p>
                    <strong>Propiedad:</strong>{" "}
                    {result.appointment.propertyStreet ?? "No especificada"}
                  </p>
                  <p>
                    <strong>Fecha:</strong>{" "}
                    {new Intl.DateTimeFormat("es-ES", {
                      ...
                      hour: "2-digit",
                      minute: "2-digit",
                    }).format(result.appointment.datetimeStart)}
                  </p>
                </div>
                <Link href="/calendario">
                  <Button variant="outline">Volver al calendario</Button>
