      ...
      <div className="mb-3 px-6">
        {config.showIcons ? (
          ...
          <div className="space-y-1">
            {config.additionalFields.map((fieldValue) => (
              <div key={fieldValue} className="flex items-center text-sm" style={{ color: modernColors.text }}>
    ...
    >
      ...
      <div className="mb-4 px-6">
        {config.showIcons ? (
          ...
          <div className="space-y-1">
            <div className="flex items-center text-sm" style={{ color: modernColors.text }}>
              <span className="w-2 h-2 rounded-full mr-3" style={{ backgroundColor: modernColors.primary }}></span>
          ...
          <div className="flex-1">
            {config.showPhone && (
              <>
                ...
                <div className="text-xs" style={{ color: modernColors.primary }}>
                  {data.contact.phone}
                </div>
              </>
            )}
