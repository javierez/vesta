...
export const ClassicTemplate: FC<ConfigurableTemplateProps> = ({
  ...
  const formatLocationWithTruncationAndBreaks = (location: {
    ...
    // Print-optimized character limits for location text
    const charLimit = config.listingType === "alquiler" ? 18 : 16;
  ...
  const renderImages = () => {
    ...
    if (config.orientation === "vertical") {
      // Vertical layout - stack images with fixed dimensions
      ...
      if (config.imageCount === 4) {
        ...
        return (
          ...
          >
            ...
            {/* Supporting images - bottom 50%, 3 columns */}
            {templateImages.slice(1, 4).map((image, index) => (
              <div
                ...
                style={{
                  ...
                  left: `${index * (subImageWidth + gap)}px`,
                  width: `${subImageWidth}px`,
        ...
        const subImageWidth = Math.floor(containerDims.width / 2) - gap / 2;
        ...
        return (
          ...
          >
            ...
            {/* Supporting images - bottom 50%, 2 columns */}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          position: "absolute",
          left: `${PRINT_DIMENSIONS.OVERLAY.left.position.left}px`,
          top: `${PRINT_DIMENSIONS.OVERLAY.left.position.top}px`,
          zIndex: 10,
      ...
      >
        <div
          style={{
            ...
            padding: `${PRINT_DIMENSIONS.SPACING.lg}px`,
          }}
        >
          {/* Top section with title and content - variable size */}
          <div style={{ flex: 1 }}>
            {/* Title - listing type and property type */}
            <div style={{ marginBottom: `${PRINT_DIMENSIONS.SPACING.md}px` }}>
              <h2
                className={cn(
                  "font-bold uppercase",
                  modernColors.text,
                ...
                style={{
                  fontSize: `${getTypographySize("title", { isCompact: locationNeedsLineBreak })}px`,
                  lineHeight: "1.2",
                  margin: 0,
                }}
              >
            ...
            <div
              style={{
                display: "flex",
                flexDirection: "column",
                gap: `${PRINT_DIMENSIONS.SPACING.sm}px`,
              }}
            >
              {/* Location */}
              <div
                ...
                style={{
                  ...
                  paddingLeft: `${PRINT_DIMENSIONS.SPACING.md}px`,
                  paddingRight: `${PRINT_DIMENSIONS.SPACING.md}px`,
                  paddingTop: `${PRINT_DIMENSIONS.SPACING.xs}px`,
                  paddingBottom: `${PRINT_DIMENSIONS.SPACING.xs}px`,
                }}
              >
                <MapPin
                  style={{
                    marginLeft: "-6px",
                    marginRight: "4px",
                    width: `${PRINT_DIMENSIONS.ICONS.small.width}px`,
                    height: `${PRINT_DIMENSIONS.ICONS.small.height}px`,
                    flexShrink: 0,
                  }}
                />
                <span
              ...
              {config.showShortDescription ? (
                <div
                  className={cn(modernColors.text)}
                  style={{
                    marginTop: `${PRINT_DIMENSIONS.SPACING.lg}px`,
          ...
          <div
            style={{
              marginTop: `${PRINT_DIMENSIONS.SPACING.sm}px`,
              textAlign: "center",
            }}
          >
            <div
        ...
        >
          <div
            style={{
              paddingLeft: `${PRINT_DIMENSIONS.SPACING.md}px`,
              paddingRight: `${PRINT_DIMENSIONS.SPACING.md}px`,
              paddingTop: `${PRINT_DIMENSIONS.SPACING.sm}px`,
              paddingBottom: `${PRINT_DIMENSIONS.SPACING.sm}px`,
            }}
          >
            ...
            <div
              style={{
                display: "flex",
                flexDirection: "column",
                gap: `${PRINT_DIMENSIONS.SPACING.xs}px`,
              }}
            >
              {config.showPhone && (
                <div
