  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Configuraciones globales y parámetros del sistema</p>
      </div>
      
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-12">
          <Settings className="h-12 w-12 text-gray-400 mb-4" />
          <CardTitle className="text-lg text-gray-600 mb-2">Configuración del Sistema</CardTitle>
