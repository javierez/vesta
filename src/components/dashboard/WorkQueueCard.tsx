              ...
              <div className="space-y-3">
                {(() => {
                  ...
                  const groupedAppointments = appointments.reduce((groups, appointment) => {
                    const dateLabel = formatAppointmentDate(appointment.startTime);
                    if (!groups[dateLabel]) {
                      groups[dateLabel] = [];
                    }
                  ...
                  return Object.entries(groupedAppointments).map(([dateLabel, dayAppointments]) => (
                    <div key={dateLabel} className="space-y-2">
                      ...
                      <div className="space-y-2">
                        {dayAppointments.map((appointment, index) => {
                          const tripTime = formatTripTime(appointment.tripTimeMinutes);
                          const colors = getAppointmentColor(appointment.appointmentType);
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="mr-3 flex flex-col items-center">
                                {tripTime ? (
                                  <>
                                    <Car className={`h-4 w-4 ${colors.icon} mb-1`} />
                                    <span className="text-xs font-medium text-gray-600">
                                      {tripTime}
                                    </span>
                                  </>
