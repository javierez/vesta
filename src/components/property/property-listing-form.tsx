...
export function PropertyListingForm() {
  ...
  const validateCurrentStep = (): boolean => {
    ...
    switch (steps[currentStep]) {
      ...
      case "economic":
        if (
          !formData.economicInfo.precioVenta &&
          !formData.economicInfo.precioAlquiler
        ) {
          newErrors.precioVenta =
            "Debe indicar al menos un precio de venta o alquiler";
          isValid = false;
        }
        break;
      ...
      case "images":
        return (
          <ImagesStep
            ...
            updateImages={(images) => updateFormData({ images })}
            errors={errors}
          />
        );
      case "review":
      ...
      <Card className="mt-8">
        <CardContent className="pt-6 text-center">
          ...
          <h2 className="mb-2 text-2xl font-bold">
            ¡Gracias por publicar tu inmueble!
          </h2>
          <p className="mb-4">
            Hemos recibido correctamente la información de tu propiedad. Uno de
            nuestros agentes se pondrá en contacto contigo en breve para
