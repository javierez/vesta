...
export function PropertyCharacteristicsFormLocal({
  listing,
}: PropertyCharacteristicsFormLocalProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <BanknoteIcon className="mr-1 h-3.5 w-3.5" />
              Local de banco
            </Button>
            <Button
      ...
      <Card
        className={cn(
          "relative p-4 transition-all duration-500 ease-out",
          getCardStyles(moduleStates.orientation?.saveState ?? "idle"),
        )}
      >
        <ModernSaveIndicator
      ...
      <div className="col-span-full grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card
          className={cn(
            "relative p-4 transition-all duration-500 ease-out",
            getCardStyles(moduleStates.premiumFeatures?.saveState ?? "idle"),
          )}
        >
          <ModernSaveIndicator
      ...
      {!(listingType === "Sale" || listingType === "Transfer") && (
        <Card
          className={cn(
            "relative p-4 transition-all duration-500 ease-out",
            getCardStyles(moduleStates.rentalProperties?.saveState ?? "idle"),
          )}
        >
          <ModernSaveIndicator
