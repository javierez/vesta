...
export function PropertyCharacteristicsFormSolar({
  listing,
}: PropertyCharacteristicsFormSolarProps) {
  ...
  const saveModule = async (moduleName: ModuleName) => {
    ...
    try {
      ...
      switch (moduleName) {
        ...
        case "propertyDetails":
          propertyData = {
            ...
            buildableArea: Number(
              (document.getElementById("buildableArea") as HTMLInputElement)
                ?.value,
            ),
            yearBuilt: Number(
        ...
        case "features":
          propertyData = {
            hasWater: (document.getElementById("hasWater") as HTMLInputElement)
              ?.checked,
            hasElectricity: (
              document.getElementById("hasElectricity") as HTMLInputElement
            )?.checked,
            hasGas: (document.getElementById("hasGas") as HTMLInputElement)
              ?.checked,
            hasSewer: (document.getElementById("hasSewer") as HTMLInputElement)
              ?.checked,
            hasInternet: (
              document.getElementById("hasInternet") as HTMLInputElement
            )?.checked,
            hasPhone: (document.getElementById("hasPhone") as HTMLInputElement)
              ?.checked,
            hasRoadAccess: (
              document.getElementById("hasRoadAccess") as HTMLInputElement
            )?.checked,
            hasFence: (document.getElementById("hasFence") as HTMLInputElement)
              ?.checked,
            hasSecurity: (
              document.getElementById("hasSecurity") as HTMLInputElement
            )?.checked,
            hasParking: (
              document.getElementById("hasParking") as HTMLInputElement
            )?.checked,
            hasStorage: (
              document.getElementById("hasStorage") as HTMLInputElement
            )?.checked,
            hasGarden: (
              document.getElementById("hasGarden") as HTMLInputElement
            )?.checked,
            hasPool: (document.getElementById("hasPool") as HTMLInputElement)
              ?.checked,
            hasTennis: (
              document.getElementById("hasTennis") as HTMLInputElement
            )?.checked,
            hasBasketball: (
              document.getElementById("hasBasketball") as HTMLInputElement
            )?.checked,
            hasFootball: (
              document.getElementById("hasFootball") as HTMLInputElement
            )?.checked,
            hasVolleyball: (
              document.getElementById("hasVolleyball") as HTMLInputElement
            )?.checked,
            hasGolf: (document.getElementById("hasGolf") as HTMLInputElement)
              ?.checked,
            hasHorseRiding: (
              document.getElementById("hasHorseRiding") as HTMLInputElement
            )?.checked,
            hasHunting: (
              document.getElementById("hasHunting") as HTMLInputElement
            )?.checked,
            hasFishing: (
              document.getElementById("hasFishing") as HTMLInputElement
            )?.checked,
            hasCamping: (
              document.getElementById("hasCamping") as HTMLInputElement
            )?.checked,
            hasPicnic: (
              document.getElementById("hasPicnic") as HTMLInputElement
            )?.checked,
            hasBBQ: (document.getElementById("hasBBQ") as HTMLInputElement)
              ?.checked,
            hasTerrace: (
              document.getElementById("hasTerrace") as HTMLInputElement
            )?.checked,
            hasBalcony: (
              document.getElementById("hasBalcony") as HTMLInputElement
            )?.checked,
            hasPatio: (document.getElementById("hasPatio") as HTMLInputElement)
              ?.checked,
            hasPorch: (document.getElementById("hasPorch") as HTMLInputElement)
              ?.checked,
            hasDeck: (document.getElementById("hasDeck") as HTMLInputElement)
              ?.checked,
            hasGazebo: (
              document.getElementById("hasGazebo") as HTMLInputElement
            )?.checked,
            hasGreenhouse: (
              document.getElementById("hasGreenhouse") as HTMLInputElement
            )?.checked,
            hasOrchard: (
              document.getElementById("hasOrchard") as HTMLInputElement
            )?.checked,
            hasVineyard: (
              document.getElementById("hasVineyard") as HTMLInputElement
            )?.checked,
            hasOliveGrove: (
              document.getElementById("hasOliveGrove") as HTMLInputElement
            )?.checked,
            hasForest: (
              document.getElementById("hasForest") as HTMLInputElement
            )?.checked,
            hasMountain: (
              document.getElementById("hasMountain") as HTMLInputElement
            )?.checked,
            hasSea: (document.getElementById("hasSea") as HTMLInputElement)
              ?.checked,
            hasRiver: (document.getElementById("hasRiver") as HTMLInputElement)
              ?.checked,
            hasLake: (document.getElementById("hasLake") as HTMLInputElement)
              ?.checked,
            hasBeach: (document.getElementById("hasBeach") as HTMLInputElement)
              ?.checked,
            hasValley: (
              document.getElementById("hasValley") as HTMLInputElement
            )?.checked,
            hasPlateau: (
              document.getElementById("hasPlateau") as HTMLInputElement
            )?.checked,
            hasHill: (document.getElementById("hasHill") as HTMLInputElement)
              ?.checked,
            hasCave: (document.getElementById("hasCave") as HTMLInputElement)
              ?.checked,
            hasQuarry: (
              document.getElementById("hasQuarry") as HTMLInputElement
            )?.checked,
            hasMine: (document.getElementById("hasMine") as HTMLInputElement)
              ?.checked,
            hasWell: (document.getElementById("hasWell") as HTMLInputElement)
              ?.checked,
            hasSpring: (
              document.getElementById("hasSpring") as HTMLInputElement
            )?.checked,
            hasStream: (
              document.getElementById("hasStream") as HTMLInputElement
            )?.checked,
            hasPond: (document.getElementById("hasPond") as HTMLInputElement)
              ?.checked,
            hasSwamp: (document.getElementById("hasSwamp") as HTMLInputElement)
              ?.checked,
            hasMarsh: (document.getElementById("hasMarsh") as HTMLInputElement)
              ?.checked,
            hasMeadow: (
              document.getElementById("hasMeadow") as HTMLInputElement
            )?.checked,
            hasPasture: (
              document.getElementById("hasPasture") as HTMLInputElement
            )?.checked,
            hasField: (document.getElementById("hasField") as HTMLInputElement)
              ?.checked,
            hasCrop: (document.getElementById("hasCrop") as HTMLInputElement)
              ?.checked,
          };
          break;
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              type="number"
              defaultValue={
                listing.price ? parseInt(listing.price.toString()) : ""
              }
