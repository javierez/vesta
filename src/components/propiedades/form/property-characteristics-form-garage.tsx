...
import { Building2, BanknoteIcon, ChevronDown, Link } from "lucide-react";
...
export function PropertyCharacteristicsFormGarage({
  listing,
}: PropertyCharacteristicsFormGarageProps) {
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              type="number"
              defaultValue={
                listing.price ? Math.round(Number(listing.price)) : undefined
              }
