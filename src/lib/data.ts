...
export const properties: Property[] = [
  {
    ...
    images: [
      ...
      { url: "/luxury-living.png", alt: "Sala de estar", tag: "Sala de estar" },
      { url: "/luxury-bedroom.png", alt: "Dormitorio principal", tag: "Dormitorio" },
      { url: "/luxury-pool.png", alt: "Piscina privada", tag: "Piscina" },
    ],
  ...
  },
  {
    ...
    images: [
      ...
      { url: "/modern-bathroom.png", alt: "Baño con acabados de lujo", tag: "Baño" },
      { url: "/city-view.png", alt: "Vistas a la ciudad", tag: "Vistas" },
      { url: "/building-gym.png", alt: "Gimnasio del edificio", tag: "Gimnasio" },
    ],
    isBankOwned: true,
  ...
  },
  {
    ...
    status: "for-sale",
    isFeatured: false,
    imageUrl: "/suburban-garden-charm.png",
    images: [
      { url: "/suburban-garden-charm.png", alt: "Vista exterior de la casa", tag: "Exterior" },
      { url: "/renovated-kitchen.png", alt: "Cocina renovada", tag: "Cocina" },
      { url: "/wooden-floor-living.png", alt: "Sala con pisos de madera", tag: "Sala de estar" },
      { url: "/backyard-terrace.png", alt: "Terraza en el patio trasero", tag: "Patio" },
      { url: "/finished-basement.png", alt: "Sótano terminado", tag: "Sótano" },
    ],
  ...
  },
  {
    ...
    status: "for-sale",
    isFeatured: false,
    imageUrl: "/brownstone-facade.png",
    images: [
      { url: "/brownstone-facade.png", alt: "Fachada del local comercial", tag: "Exterior" },
  ...
  },
  {
    ...
    status: "for-rent",
    isFeatured: false,
    imageUrl: "/beachfront-balcony-view.png",
    images: [
      { url: "/beachfront-balcony-view.png", alt: "Vista al océano desde el balcón", tag: "Vistas" },
  ...
  },
  {
    ...
    status: "for-sale",
    isFeatured: false,
    imageUrl: "/exposed-brick-loft.png",
    images: [
      { url: "/exposed-brick-loft.png", alt: "Interior del garaje", tag: "Interior" },
  ...
  },
  {
    ...
    imageUrl: "/suburban-garden-charm.png",
    images: [
      { url: "/suburban-garden-charm.png", alt: "Vista exterior con jardín", tag: "Exterior" },
