  ...
  try {
    const [tabsData] = await db
      .select({
        ...
        habitaclia: listings.habitaclia,
        milanuncios: listings.milanuncios,
        fotocasaProps: sql<{ visibilityMode?: number; hidePrice?: boolean } | null>`${listings.fotocasaProps}`,
        idealistaProps: sql<Record<string, unknown> | null>`${listings.idealistaProps}`,
        habitacliaProps: sql<Record<string, unknown> | null>`${listings.habitacliaProps}`,
        milanunciosProps: sql<Record<string, unknown> | null>`${listings.milanunciosProps}`,
        energyCertification: properties.energyCertification,
        agentId: listings.agentId,
      })
      .from(listings)
