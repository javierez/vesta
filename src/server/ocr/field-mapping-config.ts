...
export const PROPERTY_FIELD_MAPPINGS: FieldMapping[] = [
  ...
  },
  {
    ...
    dbTable: 'properties',
    aliases: ['superficie', 'metros', 'm2', 'm²', 'metros cuadrados', 'superficie útil', 'superficie construida'],
    dataType: 'number',
  ...
  },
  {
    dbColumn: 'yearBuilt',
    dbTable: 'properties',
    aliases: ['año', 'año construcción', 'año edificación', 'construccion', 'edificacion', 'construido'],
    dataType: 'number',
    validation: isYear,
    converter: toNumber,
  ...
  },
  {
    ...
    dbTable: 'properties',
    aliases: ['referencia catastral', 'ref catastral', 'catastro', 'codigo catastral'],
    dataType: 'string',
    category: 'specifications'
  },
  {
    ...
    dbTable: 'properties',
    aliases: ['superficie construida', 'superficie total', 'metros construidos', 'm2 construidos'],
    dataType: 'decimal',
    validation: isPositiveNumber,
    converter: toNumber,
    category: 'specifications'
  ...
  // Location Information
  {
    dbColumn: 'street',
    dbTable: 'properties',
    aliases: ['dirección', 'direccion', 'calle', 'avenida', 'paseo', 'plaza'],
    dataType: 'string',
    category: 'location'
  },
  {
  ...
  // Energy and Heating
  {
    ...
    dbTable: 'properties',
    aliases: ['certificado energético', 'certificado energia', 'energia', 'eficiencia energética'],
    dataType: 'string',
  ...
  },
  {
    ...
    dbTable: 'properties',
    aliases: ['escala energética', 'letra energética', 'calificación energética'],
    dataType: 'string',
  ...
  },
  {
    ...
    dataType: 'string',
    examples: ['gas individual', 'gas colectivo', 'eléctrica', 'suelo radiante'],
    category: 'energy'
  },
  ...
  // Property Characteristics
  {
    ...
    dbTable: 'properties',
    aliases: ['accesible', 'minusválidos', 'discapacitados', 'acceso minusválidos'],
    dataType: 'boolean',
    converter: toBoolean,
...
export const LISTING_FIELD_MAPPINGS: FieldMapping[] = [
  // Listing Details
  {
    ...
    dbTable: 'listings',
    aliases: ['tipo operación', 'operacion', 'venta', 'alquiler', 'rent', 'sale'],
    dataType: 'string',
    examples: ['Sale', 'Rent'],
    category: 'listing'
  },
  ...
  },
  {
    ...
    dbTable: 'listings',
    aliases: ['electrodomésticos', 'electrodomesticos', 'incluye electrodomésticos'],
    dataType: 'boolean',
    converter: toBoolean,
    category: 'listing'
  },
...
export function getFieldMappingByColumn(dbColumn: string): FieldMapping | undefined {
